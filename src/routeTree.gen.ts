...
import { Route as AdminPricingV3RouteImport } from './routes/admin/pricing-v3'
import { Route as AdminPricingEngineRouteImport } from './routes/admin/pricing-engine'
...
import { Route as AdminPricingV2RecipeCostsRouteImport } from './routes/admin/pricing-v2.recipe-costs'
import { Route as AdminPricingV2MenuPricesRouteImport } from './routes/admin/pricing-v2.menu-prices'
...
import { Route as AdminPricingV2CostQueueRouteImport } from './routes/admin/pricing-v2.cost-queue'
...
import { Route as AdminPricingV2BulkSuggestRouteImport } from './routes/admin/pricing-v2.bulk-suggest'
...
const AdminQuoteCreatorRoute = AdminQuoteCreatorRouteImport.update({
  id: '/quote-creator',
  path: '/quote-creator',
  getParentRoute: () => AdminRoute,
} as any)
...
const AdminPricingV3Route = AdminPricingV3RouteImport.update({
  id: '/pricing-v3',
  path: '/pricing-v3',
  getParentRoute: () => AdminRoute,
} as any)
const AdminPricingEngineRoute = AdminPricingEngineRouteImport.update({
  id: '/pricing-engine',
  path: '/pricing-engine',
  getParentRoute: () => AdminRoute,
} as any)
...
const AdminQuoteCreatorIdRoute = AdminQuoteCreatorIdRouteImport.update({
  id: '/$id',
  path: '/$id',
...
const AdminPricingV2SearchRoute = AdminPricingV2SearchRouteImport.update({
  id: '/pricing-v2/search',
  path: '/pricing-v2/search',
  getParentRoute: () => AdminRoute,
} as any)
const AdminPricingV2RecipesNormalizeRoute =
  AdminPricingV2RecipesNormalizeRouteImport.update({
    id: '/pricing-v2/recipes-normalize',
    path: '/pricing-v2/recipes-normalize',
    getParentRoute: () => AdminRoute,
  } as any)
const AdminPricingV2RecipeCostsRoute =
  AdminPricingV2RecipeCostsRouteImport.update({
    id: '/pricing-v2/recipe-costs',
    path: '/pricing-v2/recipe-costs',
    getParentRoute: () => AdminRoute,
  } as any)
const AdminPricingV2MenuPricesRoute =
  AdminPricingV2MenuPricesRouteImport.update({
    id: '/pricing-v2/menu-prices',
    path: '/pricing-v2/menu-prices',
    getParentRoute: () => AdminRoute,
  } as any)
...
const AdminPricingV2CostQueueRoute = AdminPricingV2CostQueueRouteImport.update({
  id: '/pricing-v2/cost-queue',
  path: '/pricing-v2/cost-queue',
  getParentRoute: () => AdminRoute,
} as any)
const AdminPricingV2CatalogDataRoute =
  AdminPricingV2CatalogDataRouteImport.update({
    id: '/pricing-v2/catalog-data',
    path: '/pricing-v2/catalog-data',
    getParentRoute: () => AdminRoute,
  } as any)
const AdminPricingV2CatalogRoute = AdminPricingV2CatalogRouteImport.update({
  id: '/pricing-v2/catalog',
  path: '/pricing-v2/catalog',
  getParentRoute: () => AdminRoute,
} as any)
const AdminPricingV2BulkSuggestRoute =
  AdminPricingV2BulkSuggestRouteImport.update({
    id: '/pricing-v2/bulk-suggest',
    path: '/pricing-v2/bulk-suggest',
    getParentRoute: () => AdminRoute,
  } as any)
...
const AdminLeadsImportRoute = AdminLeadsImportRouteImport.update({
  id: '/leads/import',
  path: '/leads/import',
  getParentRoute: () => AdminRoute,
} as any)
...
const ApiPublicHooksCateringFollowupsRoute =
  ApiPublicHooksCateringFollowupsRouteImport.update({
    id: '/api/public/hooks/catering-followups',
...
export interface FileRoutesByFullPath {
  ...
  '/admin/pricing-engine': typeof AdminPricingEngineRoute
  '/admin/pricing-v3': typeof AdminPricingV3Route
  ...
  '/admin/pricing-v2/bulk-suggest': typeof AdminPricingV2BulkSuggestRoute
  ...
  '/admin/pricing-v2/cost-queue': typeof AdminPricingV2CostQueueRoute
  '/admin/pricing-v2/errors': typeof AdminPricingV2ErrorsRoute
  '/admin/pricing-v2/keywords': typeof AdminPricingV2KeywordsRoute
  '/admin/pricing-v2/menu-prices': typeof AdminPricingV2MenuPricesRoute
  '/admin/pricing-v2/recipe-costs': typeof AdminPricingV2RecipeCostsRoute
...
export interface FileRouteTypes {
  ...
  fullPaths:
    ...
    | '/admin/pricing-v2/bulk-suggest'
    | '/admin/pricing-v2/catalog'
    | '/admin/pricing-v2/catalog-data'
    | '/admin/pricing-v2/cost-queue'
    | '/admin/pricing-v2/errors'
    | '/admin/pricing-v2/keywords'
    | '/admin/pricing-v2/menu-prices'
    | '/admin/pricing-v2/recipe-costs'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/admin/quote-creator': {
      id: '/admin/quote-creator'
      path: '/quote-creator'
      fullPath: '/admin/quote-creator'
      preLoaderRoute: typeof AdminQuoteCreatorRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/quick-quote': {
    ...
    '/admin/pricing-v3': {
      id: '/admin/pricing-v3'
      path: '/pricing-v3'
      fullPath: '/admin/pricing-v3'
      preLoaderRoute: typeof AdminPricingV3RouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-engine': {
      id: '/admin/pricing-engine'
      path: '/pricing-engine'
      fullPath: '/admin/pricing-engine'
      preLoaderRoute: typeof AdminPricingEngineRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-code-inventory': {
    ...
    '/admin/quote-creator/$id': {
      id: '/admin/quote-creator/$id'
      path: '/$id'
      fullPath: '/admin/quote-creator/$id'
      preLoaderRoute: typeof AdminQuoteCreatorIdRouteImport
      parentRoute: typeof AdminQuoteCreatorRoute
    }
    '/admin/pricing/national': {
    ...
    '/admin/pricing-v2/search': {
      id: '/admin/pricing-v2/search'
      path: '/pricing-v2/search'
      fullPath: '/admin/pricing-v2/search'
      preLoaderRoute: typeof AdminPricingV2SearchRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/recipes-normalize': {
      id: '/admin/pricing-v2/recipes-normalize'
      path: '/pricing-v2/recipes-normalize'
      fullPath: '/admin/pricing-v2/recipes-normalize'
      preLoaderRoute: typeof AdminPricingV2RecipesNormalizeRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/recipe-costs': {
      id: '/admin/pricing-v2/recipe-costs'
      path: '/pricing-v2/recipe-costs'
      fullPath: '/admin/pricing-v2/recipe-costs'
      preLoaderRoute: typeof AdminPricingV2RecipeCostsRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/menu-prices': {
      id: '/admin/pricing-v2/menu-prices'
      path: '/pricing-v2/menu-prices'
      fullPath: '/admin/pricing-v2/menu-prices'
      preLoaderRoute: typeof AdminPricingV2MenuPricesRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/keywords': {
    ...
    '/admin/pricing-v2/cost-queue': {
      id: '/admin/pricing-v2/cost-queue'
      path: '/pricing-v2/cost-queue'
      fullPath: '/admin/pricing-v2/cost-queue'
      preLoaderRoute: typeof AdminPricingV2CostQueueRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/catalog-data': {
      id: '/admin/pricing-v2/catalog-data'
      path: '/pricing-v2/catalog-data'
      fullPath: '/admin/pricing-v2/catalog-data'
      preLoaderRoute: typeof AdminPricingV2CatalogDataRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/catalog': {
      id: '/admin/pricing-v2/catalog'
      path: '/pricing-v2/catalog'
      fullPath: '/admin/pricing-v2/catalog'
      preLoaderRoute: typeof AdminPricingV2CatalogRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/pricing-v2/bulk-suggest': {
      id: '/admin/pricing-v2/bulk-suggest'
      path: '/pricing-v2/bulk-suggest'
      fullPath: '/admin/pricing-v2/bulk-suggest'
      preLoaderRoute: typeof AdminPricingV2BulkSuggestRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/menu-modules/preview': {
    ...
    '/admin/leads/import': {
      id: '/admin/leads/import'
      path: '/leads/import'
      fullPath: '/admin/leads/import'
      preLoaderRoute: typeof AdminLeadsImportRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/leads/$id': {
      id: '/admin/leads/$id'
    ...
    '/api/public/hooks/pricing-v2-keyword-schedules': {
      id: '/api/public/hooks/pricing-v2-keyword-schedules'
      path: '/api/public/hooks/pricing-v2-keyword-schedules'
      fullPath: '/api/public/hooks/pricing-v2-keyword-schedules'
      preLoaderRoute: typeof ApiPublicHooksPricingV2KeywordSchedulesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/hooks/outlook-poll-inbox': {
      id: '/api/public/hooks/outlook-poll-inbox'
    ...
    '/api/public/hooks/catering-followups': {
      id: '/api/public/hooks/catering-followups'
      path: '/api/public/hooks/catering-followups'
      fullPath: '/api/public/hooks/catering-followups'
...
interface AdminQuoteCreatorRouteChildren {
  AdminQuoteCreatorIdRoute: typeof AdminQuoteCreatorIdRoute
}

const AdminQuoteCreatorRouteChildren: AdminQuoteCreatorRouteChildren = {
  AdminQuoteCreatorIdRoute: AdminQuoteCreatorIdRoute,
}

const AdminQuoteCreatorRouteWithChildren =
  AdminQuoteCreatorRoute._addFileChildren(AdminQuoteCreatorRouteChildren)
...
interface AdminRouteChildren {
  ...
  AdminPricingEngineRoute: typeof AdminPricingEngineRoute
  AdminPricingV3Route: typeof AdminPricingV3Route
  ...
  AdminPricingV2BulkSuggestRoute: typeof AdminPricingV2BulkSuggestRoute
  ...
  AdminPricingV2CostQueueRoute: typeof AdminPricingV2CostQueueRoute
  AdminPricingV2ErrorsRoute: typeof AdminPricingV2ErrorsRoute
  AdminPricingV2KeywordsRoute: typeof AdminPricingV2KeywordsRoute
  AdminPricingV2MenuPricesRoute: typeof AdminPricingV2MenuPricesRoute
  AdminPricingV2RecipeCostsRoute: typeof AdminPricingV2RecipeCostsRoute
...
const AdminRouteChildren: AdminRouteChildren = {
  ...
  AdminPricingEngineRoute: AdminPricingEngineRoute,
  AdminPricingV3Route: AdminPricingV3Route,
  ...
  AdminPricingV2BulkSuggestRoute: AdminPricingV2BulkSuggestRoute,
  AdminPricingV2CatalogRoute: AdminPricingV2CatalogRoute,
  AdminPricingV2CatalogDataRoute: AdminPricingV2CatalogDataRoute,
  AdminPricingV2CostQueueRoute: AdminPricingV2CostQueueRoute,
  AdminPricingV2ErrorsRoute: AdminPricingV2ErrorsRoute,
  AdminPricingV2KeywordsRoute: AdminPricingV2KeywordsRoute,
  AdminPricingV2MenuPricesRoute: AdminPricingV2MenuPricesRoute,
  AdminPricingV2RecipeCostsRoute: AdminPricingV2RecipeCostsRoute,
