      ...
      <section className="relative pt-16 min-h-[90vh] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            <p className="text-gold font-medium text-sm tracking-widest uppercase mb-4">Premium Catering Solutions</p>
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-background leading-tight">
              Exceptional Events, <br />
              <span className="text-gradient-gold">Perfectly Quoted</span>
            </h1>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-warm font-medium text-sm tracking-widest uppercase mb-2">Why TasteQuote</p>
