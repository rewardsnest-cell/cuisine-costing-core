...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/menu-modules/preview", label: "Menu Modules Preview",    icon: UtensilsCrossed },
  ...
  {
    label: "Ingredients & Items",
    items: [
      { to: "/admin/items",                       label: "Items",                       icon: Package },
      { to: "/admin/ingredient-reference",        label: "Ingredient Reference",        icon: BookOpen },
      { to: "/admin/ingredients/review-unlinked", label: "Review Unlinked Ingredients", icon: FileSearch },
  ...
  },
  {
    ...
    items: [
      { to: "/admin/leads/import",         label: "Import Leads",            icon: FileText },
      { to: "/admin/outreach",             label: "Outreach",                icon: Mail },
      { to: "/admin/catering-contacts",    label: "Catering Contacts",       icon: Users },
      { to: "/admin/local-catering-contacts", label: "Local Catering Contacts", icon: Users },
      { to: "/admin/affiliates",           label: "Affiliates",              icon: Repeat },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/files-reports",    label: "Files & Reports",        icon: FileText,    featureKey: "admin_downloads" },
      { to: "/admin/downloads",        label: "Downloads Hub",          icon: FileText,    featureKey: "admin_downloads" },
      { to: "/admin/uploads",          label: "Uploads",                icon: FileText },
      ...
      { to: "/admin/scan-assets",      label: "Scan Assets",            icon: ScanLine },
    ],
  },
  {
    label: "Pricing v2",
