...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Thoughtful catering for weddings and gatherings, plus calm, reliable recipes for everyday cooking. Aurora, Ohio." },
      { name: "twitter:description", content: "Thoughtful catering for weddings and gatherings, plus calm, reliable recipes for everyday cooking. Aurora, Ohio." },
      { name: "twitter:card", content: "summary" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f296cef8-15f3-4ff5-8a23-1b3913c14e33" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f296cef8-15f3-4ff5-8a23-1b3913c14e33" },
    ],
    links: [
