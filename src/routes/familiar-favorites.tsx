...
export const Route = createFileRoute("/familiar-favorites")({
  head: () => ({
    meta: [
      { title: "Familiar Favorites — VPS Finest" },
      { name: "description", content: "Classic flavors you already love — prepared our way. Original recipes inspired by well-known flavors, created and tested in our kitchen." },
      { property: "og:title", content: "Familiar Favorites — VPS Finest" },
      { property: "og:description", content: "Classic flavors you already love — prepared our way." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: `${SITE}/familiar-favorites` },
    ],
    links: [{ rel: "canonical", href: `${SITE}/familiar-favorites` }],
  }),
  component: FamiliarFavoritesLanding,
...
function FamiliarFavoritesLanding() {
  return (
    <FeatureGate featureKey="familiar_favorites" label="Familiar Favorites">
      <FamiliarFavoritesLandingInner />
    </FeatureGate>
  );
}

function FamiliarFavoritesLandingInner() {
    ...
    <div className="min-h-screen bg-background">
      <section className="pt-32 pb-10 text-center">
        <div className="max-w-3xl mx-auto px-6">
          <p className="text-xs tracking-[0.25em] uppercase text-muted-foreground mb-5">Familiar Favorites</p>
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed font-light">
            Classic flavors you already love — prepared our way.
          </p>
      ...
      <section className="pb-12 max-w-3xl mx-auto px-4 sm:px-6">
        <RecipeEmailCTA recipeId="" recipeName="Familiar Favorites" />
      </section>
      ...
      <section className="pb-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="text-center max-w-md mx-auto py-12">
            <p className="text-muted-foreground mb-2">First Familiar Favorites coming soon.</p>
